...
Route::get('/searchSale', 'SaleController@searchSaleView');
Route::post('/searchSaleById', 'SaleController@searchSaleById');
...
Route::group(['middleware'=>'auth'], function(){
    ...
    Route::post('reporte/creditsReport', 'ReportController@creditsReport');
    Route::post('reporte/download/excel/creditsReport', 'ReportController@creditsReportDownloadXLS');
    Route::post('reporte/download/creditsReport', 'ReportController@creditsReportDownload');
    Route::get('sales/client/{id}', 'SaleController@salesByClient');

    Route::post('reporte/purchasesReport', 'ReportController@purchaseReport');
    Route::post('reporte/download/excel/purchasesReport', 'ReportController@purchaseReportDownloadXLS');
    Route::post('reporte/download/purchasesReport', 'ReportController@purchaseReportDownload');

    Route::get('client/status/{id}', 'ReportController@accountStatus');
