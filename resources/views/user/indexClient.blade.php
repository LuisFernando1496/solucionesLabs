                ...
                <div class="modal-body">
                    <form id="myForm" action="/users" method="post" onsubmit="upperCreate()">
                        ...
                        <div class="form-group my-3 mx-3">
                            ...
                            <input type="text" class="form-control" name="payment_days" id="payment_days" value="" required />
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myFormEdit" action="/users" method="post" onsubmit="upperCreate()">
                        ...
                        <div class="form-group my-3 mx-3">
                            <label for="payment_days">Días de pago</label>
                            <input type="text" class="form-control" name="payment_days" id="payment_days_edit" value="" required />
                        </div>
        ...
        <tbody id="mydata">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="sales/client/{{$item->id}}" type="button" class="btn btn-outline-primary btn-sm">
                    ...
                    <a href="client/status/{{$item->id}}" type="button" class="btn btn-outline-primary btn-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                            <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                            <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                        </svg>
...
<script>
    ...
    function llenar(item) {
        ...
        document.getElementById('payment_days_edit').value = item.payment_days
