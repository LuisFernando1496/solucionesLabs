            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myForm" action="/product" enctype="multipart/form-data" method="post" onsubmit="upperCreate()">
                        ...
                        <div class="form-group my-3 mx-3">
                            <label for="minimun_stock">Stock minimo</label>
                            <input class="form-control" type="number" name="minimun_stock" id="minimun_stock" placeholder="Stock" required>
                        </div>

                        <div class="form-group my-3 mx-3">
                            <label for="price">Costo</label>
                            <input class="form-control" type="number" step="any" name="cost" id="cost" placeholder="Costo" required>
                        </div>
                        <div class="form-group my-3 mx-3">
                        ...
                        <div class="form-group my-3 mx-3">
                            ...
                            <input class="form-control" type="number" step="any" name="price_1" id="price_1" placeholder="Precio 1" required>
                        </div>
                        <div class="form-group my-3 mx-3">
                            <label for="price">Precio 2</label>
                            <input class="form-control" type="number" step="any" name="price_2" id="price_2" placeholder="Precio 2">
                        </div>
                        <div class="form-group my-3 mx-3">
                            <label for="price">Precio 3</label>
                            <input class="form-control" type="number" step="any" name="price_3" id="price_3" placeholder="Precio 3">
                        </div>  
                        <div class="form-group my-3 mx-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myFormEdit" action="/product" method="post" enctype="multipart/form-data" onsubmit="upperCreate()">
                        ...
                        <div class="form-group my-3 mx-3">
                            <label for="minimun_stock">Stock minimo</label>
                            <input class="form-control" type="number" name="minimun_stock" id="minimun_stock_edit" placeholder="Stock" required>
                        </div>

                        <div class="form-group my-3 mx-3">
                            <label for="price">Costo</label>
                            <input class="form-control" type="number" name="cost" step="any" id="cost_edit" placeholder="Costo" required>
                        </div>
                        <div class="form-group my-3 mx-3">
                            <label for="expiration">Caducidad</label>
                        ...
                        <div class="form-group my-3 mx-3">
                            <label for="price">Precio 1</label>
                            <input class="form-control" type="number" step="any" name="price_1" id="price_1_edit" placeholder="Precio 1" required>
                        </div>
                        <div class="form-group my-3 mx-3">
                            <label for="price">Precio 2</label>
                            <input class="form-control" type="number" step="any" name="price_2" id="price_2_edit" placeholder="Precio 2">
                        </div>
                        <div class="form-group my-3 mx-3">
                            <label for="price">Precio 3</label>
                            <input class="form-control" type="number" step="any" name="price_3" id="price_3_edit" placeholder="Precio 3">
                        </div>  
                        <div class="form-group my-3 mx-3">
                            <label for="iva">Iva</label>
...
<script>
    ...
    function llenar(item){
        ...
        document.getElementById('minimun_stock_edit').value = item.minimun_stock
